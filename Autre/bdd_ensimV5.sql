...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : Dim 22 jan. 2023 à 11:33
...
(2, 230001, 'sfdgh', 'sdfg', 'sdfg', 'dfg@gmail.com', '552354', 3, 10);
...
(2201230001, 50, 0, NULL, NULL, '2023-01-22', 10, 230001, 1);
...
(2, 2, NULL, 2201230001, 12, 'En stock', 1);
...
--
ALTER TABLE `item`
  ADD CONSTRAINT `fk_item_id_membership` FOREIGN KEY (`id_membership`) REFERENCES `grillepoint` (`id_membership`) ON DELETE CASCADE ON UPDATE CASCADE;
