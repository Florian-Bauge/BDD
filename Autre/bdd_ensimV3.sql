...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : sam. 21 jan. 2023 à 18:04
...
(2, '20', 'rue', 'Jean Moulin', 72000, 'Lemans', 'FRANCE', '', 230001);
...
(1, 230001, 'sdfghj', 'fghjkl', 'fghjklk', 'ef@gmail.com', '8542', 0, 540);
...
(2101230001, 0, 0, 'Qsdgj', 'qsfdhg', '2023-01-23', 0, 230001, 1),
(2101230002, 50, 0, NULL, NULL, '2023-01-21', 10, 230001, 1);
...
(1, '2023-01-21', 500, 1, 2101230002, NULL),
(13, '2023-01-21', 20, 1, 2101230002, NULL);
...
(7, 20, '2023-01-10', 230001),
(8, 15, '2023-01-21', 230001);
...
--
ALTER TABLE `points`
  ADD CONSTRAINT `fk_point_code_client` FOREIGN KEY (`code_client`) REFERENCES `client` (`code_client`) ON DELETE CASCADE ON UPDATE RESTRICT;
